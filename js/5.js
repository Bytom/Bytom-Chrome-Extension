...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_advancedTransfer_vue__ = __webpack_require__(606);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b2586742_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_advancedTransfer_vue__ = __webpack_require__(669);
...
/* scopeId */
var __vue_scopeId__ = "data-v-b2586742"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_advancedTransfer_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b2586742_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_advancedTransfer_vue__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_extends__ = __webpack_require__(532);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_extension_streams__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_extension_streams___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_extension_streams__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_BrowserApis__ = __webpack_require__(529);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_NotificationService__ = __webpack_require__(534);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models_account__ = __webpack_require__(435);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils_Number__ = __webpack_require__(580);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_9_vuex__["c" /* mapGetters */])(['currentAccount', 'net', 'netType'])),
  watch: {},
  methods: {
    close: function close() {
      __WEBPACK_IMPORTED_MODULE_8__services_NotificationService__["a" /* default */].close();
    },
    transfer: function transfer() {
      ...
      __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].buildTransaction(this.address, this.transaction.input, this.transaction.output, this.transaction.fee, this.transaction.confirmations).then(function () {
        var _ref = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee(result) {
          var arrayData;
          return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (!_this.transaction.args) {
                    _context.next = 5;
                    break;
                  }

                  _context.next = 4;
                  return __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].convertArgument(_this.transaction.args);

                case 4:
                  arrayData = _context.sent;

                case 5:
                  return _context.abrupt("return", __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].advancedTransfer(_this.currentAccount.guid, result[0], _this.password, arrayData, _this.address).then(function (resp) {
                    loader.hide();
    ...
    queryAsset: function queryAsset(assetID) {
      return __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].asset(assetID);
    }
  }, mounted: function mounted() {
    var _this2 = this;

    this.prompt = window.data || __WEBPACK_IMPORTED_MODULE_7__utils_BrowserApis__["a" /* apis */].extension.getBackgroundPage().notification || null;

    if (this.prompt.data !== undefined) {
      var inout = this.prompt.data;
      ...
      var array = inout.input.filter(function (action) {
        return action.type === 'spend_wallet';
      });

      if (array.length > 0) {
        __WEBPACK_IMPORTED_MODULE_11__models_account__["a" /* default */].setupNet("" + this.net + this.netType);
        var promise = __WEBPACK_IMPORTED_MODULE_10_lodash___default()(array).groupBy('asset').map(function (objs, key) {
          return _this2.queryAsset(key).then(function (resp) {
            return {
              'asset': key,
              'alias': resp.symbol,
              'amount': __WEBPACK_IMPORTED_MODULE_10_lodash___default.a.sumBy(objs, 'amount')
            };
          });
        });
...
var update = __webpack_require__(84)("f4608966", content, true, {});
