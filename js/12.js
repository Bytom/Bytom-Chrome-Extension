...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_voteRecord_vue__ = __webpack_require__(598);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4511a71c_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_voteRecord_vue__ = __webpack_require__(640);
...
/* scopeId */
var __vue_scopeId__ = "data-v-4511a71c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_voteRecord_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4511a71c_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_voteRecord_vue__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__store_constants__ = __webpack_require__(269);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["d" /* mapState */])(['bytom', 'currentAsset', 'listVote']), Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["c" /* mapGetters */])(['currentAccount', 'currency'])),
    methods: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
        ...
        refreshTransactions: function refreshTransactions(start, limit) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
                __WEBPACK_IMPORTED_MODULE_3__models_transaction__["a" /* default */].list(_this2.currentAccount.vpAddress, __WEBPACK_IMPORTED_MODULE_4__utils_constants__["a" /* BTM */], start, limit, tx_types).then(function (transactions) {
                    if (transactions == null) {
                        return;
                    }

                    var formattedTx = _this2.transactionsFormat(transactions);
                    resolve(formattedTx);
                }).catch(function (error) {
                    console.log(error);
                    reject(error);
        ...
        transactionsFormat: function transactionsFormat(transactions) {
            ...
            var assetID = __WEBPACK_IMPORTED_MODULE_4__utils_constants__["a" /* BTM */];
            ...
            transactions.forEach(function (transaction) {
                ...
                var filterInput = transaction.types.includes('veto');
                var allVotes = _this3.listVote;

                if (filterInput) {
                    transaction.type = 'veto';
                    var pubkey = transaction.inputs.filter(function (i) {
                        return i.type === 'veto';
                    })[0].vote;

                    var inAmount = __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.sumBy(transaction.inputs.filter(function (i) {
                        return i.type === 'veto';
                    }), 'amount');
                    var outAmount = __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.sumBy(transaction.outputs.filter(function (i) {
                        return i.type === 'vote';
                    }), 'amount');
                    transaction.vAmount = __WEBPACK_IMPORTED_MODULE_8__utils_Number__["a" /* Number */].formatNue(inAmount - outAmount, 8);
                    transaction.vName = __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.find(allVotes, { pubKey: pubkey }).name;
                } else if (transaction.types.includes('vote')) {

                    var _pubkey = transaction.outputs.filter(function (i) {
                        return i.type === 'vote';
                    })[0].vote;

                    var _outAmount = __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.sumBy(transaction.outputs.filter(function (i) {
                        return i.type === 'vote';
                    }), 'amount');
                    transaction.vAmount = __WEBPACK_IMPORTED_MODULE_8__utils_Number__["a" /* Number */].formatNue(_outAmount, 8);
                    transaction.vName = __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.find(allVotes, { pubKey: _pubkey }).name;
                ...
                if (balanceObject.length === 1) {
                    ...
                    transaction.val = __WEBPACK_IMPORTED_MODULE_8__utils_Number__["a" /* Number */].formatNue(val, 8);
    ...
    }, Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["b" /* mapActions */])([__WEBPACK_IMPORTED_MODULE_6__store_constants__["n" /* UPDATE_STORED_BYTOM */]])),
...
var update = __webpack_require__(84)("9d5a4e40", content, true, {});
...
// module
exports.push([module.i, ".header[data-v-4511a71c]{display:flex}.header p[data-v-4511a71c]{text-align:center;width:280px;padding-top:17px}.topbar-left .btn-menu i[data-v-4511a71c]{font-size:100%}.transaction-title h3[data-v-4511a71c]{font-size:16px;font-weight:inherit;padding:10px 0 10px 20px}.transactions[data-v-4511a71c]{font-size:15px;height:500px}.list-item-non[data-v-4511a71c]{padding:10px 20px;display:flex;justify-content:space-between;position:relative;cursor:auto}.list-item-non[data-v-4511a71c]:after{content:\"\";background:#e0e0e0;position:absolute;bottom:0;left:20px;height:1px;width:90%}.addr[data-v-4511a71c]{font-size:12px}.no-record[data-v-4511a71c]{display:block}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"warp-chlid bg-white"},[_c('section',{staticClass:"header bg-header"},[_c('i',{staticClass:"iconfont icon-back",on:{"click":_vm.close}}),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.$t('listVote.voteRecord')))])]),_vm._v(" "),_c('section',{staticClass:"transactions"},[(_vm.transactions.length != 0)?_c('div',{staticClass:"transactions"},[_c('vue-scroll',{ref:"vs",on:{"handle-scroll":_vm.handleScroll}},[_c('ul',{staticClass:"list"},_vm._l((_vm.transactions),function(transaction,index){return _c('li',{key:index,staticClass:"list-item-non bg-white"},[_c('div',[_c('div',[_vm._v("\n                                "+_vm._s(transaction.vName)+"\n                              ")]),_vm._v(" "),_c('div',{staticClass:"addr color-grey"},[(transaction.hasOwnProperty('blockTimestamp'))?_c('div',[_vm._v("\n                                  "+_vm._s(_vm._f("moment")(transaction.submissionTimestamp))+"\n                                ")]):_c('div',[_vm._v("\n                                  "+_vm._s(_vm.$t('main.unconfirmed'))+"\n                                ")])])]),_vm._v(" "),_c('div',{staticClass:"text-align-right"},[_c('div',{staticClass:"value"},[_vm._v(_vm._s(transaction.vAmount)+" BTM")]),_vm._v(" "),(transaction.type == 'vote')?_c('div',{staticClass:"addr color-grey"},[_vm._v(_vm._s(_vm.$t('listVote.vote')))]):(transaction.type == 'veto')?_c('div',{staticClass:"addr color-grey"},[_vm._v(_vm._s(_vm.$t('listVote.cancelVote')))]):_vm._e()])])}))])],1):_c('div',[_c('div',{staticClass:"bg-emptytx"}),_vm._v(" "),_c('div',[_c('span',{staticClass:"color-lightgrey center-text no-record"},[_vm._v(_vm._s(_vm.$t('main.noRecord')))])])])])])}
var staticRenderFns = []
