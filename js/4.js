...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_signTransaction_vue__ = __webpack_require__(607);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c62da73e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_signTransaction_vue__ = __webpack_require__(672);
...
/* scopeId */
var __vue_scopeId__ = "data-v-c62da73e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_signTransaction_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c62da73e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_signTransaction_vue__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_transaction__ = __webpack_require__(577);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_language_sdk__ = __webpack_require__(579);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_extension_streams__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_extension_streams___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_extension_streams__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__models_account__ = __webpack_require__(435);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_7_vuex__["c" /* mapGetters */])(['currentAccount', 'net', 'netType'])),
    watch: {},
    methods: {
        ...
        transfer: function transfer() {
            ...
            if (Array.isArray(this.prompt.data)) {
                __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(this.prompt.data.map(function (rawdata) {
                    return __WEBPACK_IMPORTED_MODULE_2__models_transaction__["a" /* default */].signTransaction(_this.currentAccount.guid, rawdata, _this.password);
                })).then(function (result) {
                    loader.hide();
                    _this.prompt.responder(result);
                    _this.$dialog.show({
                        type: 'success',
                ...
                __WEBPACK_IMPORTED_MODULE_2__models_transaction__["a" /* default */].signTransaction(this.currentAccount.guid, this.prompt.data, this.password).then(function (result) {
                    loader.hide();
                    _this.prompt.responder(result);
                    _this.$dialog.show({
                        type: 'success',
        ...
        queryAsset: function queryAsset(assetID) {
            return __WEBPACK_IMPORTED_MODULE_2__models_transaction__["a" /* default */].asset(assetID);
        }
        ...
        if (this.prompt.data !== undefined) {
            var param = Array.isArray(this.prompt.data) ? this.prompt.data[0].tx : this.prompt.data.tx;
            ...
            var array = param.inputs.filter(function (action) {
                return action.type === 'spend';
            });

            if (array.length > 0) {
                __WEBPACK_IMPORTED_MODULE_9__models_account__["a" /* default */].setupNet("" + this.net + this.netType);
                var promise = __WEBPACK_IMPORTED_MODULE_8_lodash___default()(array).groupBy('asset').map(function (objs, key) {
                    return _this2.queryAsset(key).then(function (resp) {
                        return {
                            'asset': key,
                            'alias': resp.alias,
                            'amount': __WEBPACK_IMPORTED_MODULE_10__utils_Number__["a" /* Number */].formatNue(__WEBPACK_IMPORTED_MODULE_8_lodash___default.a.sumBy(objs, 'amount'), resp.decimals)
                        };
                    });
                });

                var that = this;
                __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(promise).then(function (output) {
...
var update = __webpack_require__(84)("7b943fec", content, true, {});
...
// module
exports.push([module.i, ".warp[data-v-c62da73e]{position:absolute;top:0;left:0;right:0;height:600px;z-index:2;overflow:scroll}.header[data-v-c62da73e]{display:flex}.header p[data-v-c62da73e]{text-align:center;width:280px;padding-top:17px}.content[data-v-c62da73e]{margin:20px;padding:20px;overflow:hidden;border-radius:4px;width:280px}.divider[data-v-c62da73e]{margin:12px 0}.value .uint[data-v-c62da73e]{font-size:12px;margin-left:3px}.btn-inline .btn[data-v-c62da73e]{margin:10px 15px}.row[data-v-c62da73e]{word-break:break-all}.col[data-v-c62da73e]{font-size:14px;width:35%}.label[data-v-c62da73e]{color:#7b7b7b}.value[data-v-c62da73e]{color:#282828;width:60%}table[data-v-c62da73e]{width:100%}.form-item[data-v-c62da73e]{padding:0;margin:0;margin-bottom:10px}.hide[data-v-c62da73e]{width:175px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.view-link[data-v-c62da73e]{font-size:14px;color:#035bd4;width:275px;display:block}", ""]);
