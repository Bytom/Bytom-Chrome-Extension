...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_transferConfirm_vue__ = __webpack_require__(583);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_15e0b1d0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_transferConfirm_vue__ = __webpack_require__(590);
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_transferConfirm_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_15e0b1d0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_transferConfirm_vue__["a" /* default */],
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_crossChainTransaction_vue__ = __webpack_require__(603);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_aa5cc95c_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_crossChainTransaction_vue__ = __webpack_require__(658);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-aa5cc95c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_crossChainTransaction_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_aa5cc95c_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_crossChainTransaction_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_9_vuex__["c" /* mapGetters */])(['language', 'net', 'netType'])),
  methods: {
    ...
    transfer: function transfer() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(this.rawData.map(function (rawdata) {
        return __WEBPACK_IMPORTED_MODULE_3__models_transaction__["a" /* default */].transfer(_this.account.guid, rawdata, _this.password, address);
      })).then(function (ret) {
        loader.hide();
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(84)("ad6a94de", content, true, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_address__ = __webpack_require__(437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_account__ = __webpack_require__(435);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_transaction__ = __webpack_require__(577);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_language_sdk__ = __webpack_require__(579);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__transferConfirm__ = __webpack_require__(533);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_constants__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vuex__ = __webpack_require__(433);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__utils_Number__ = __webpack_require__(580);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_lodash__ = __webpack_require__(434);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    Confirm: __WEBPACK_IMPORTED_MODULE_6__transferConfirm__["default"]
  },
  data: function data() {
    return {
      selectAsset: {
        asset: {
          assetId: __WEBPACK_IMPORTED_MODULE_7__utils_constants__["a" /* BTM */],
          symbol: "BTM",
          decimals: 8
        }
      },
      ...
      transaction: {
        type: 'toVapor',
        asset: __WEBPACK_IMPORTED_MODULE_7__utils_constants__["a" /* BTM */],
        fee: 0,
        amount: "",
        to: '',
        confirmations: 1
  ...
  computed: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
    ...
    bytomBalance: function bytomBalance() {
      var _this = this;
      ...
      if (balances && balances.length > 0) {
        var balanceObject = balances.filter(function (b) {
          return b.asset.assetId === _this.selectAsset.asset.assetId;
        })[0];
        balance = __WEBPACK_IMPORTED_MODULE_9__utils_Number__["a" /* Number */].formatNue(balanceObject.availableBalance, balanceObject.decimals);
      }
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_8_vuex__["d" /* mapState */])(['bytom']), Object(__WEBPACK_IMPORTED_MODULE_8_vuex__["c" /* mapGetters */])(['currentAccount', 'accountList', 'net', 'netType', 'currency'])),
  watch: {
    "transaction.amount": function transactionAmount(newAmount) {
      this.transaction.cost = Number(this.selectAsset[currencyInPrice[this.currency]] * newAmount).toFixed(2);
    },
    account: function account(newAccount) {
      this.guid = newAccount.guid;
    },
    guid: function guid(newGuid) {
      var _this2 = this;
      ...
      __WEBPACK_IMPORTED_MODULE_3__models_account__["a" /* default */].balance(this.address).then(function (balances) {
        var balance = 0.00;
        if (balances.length > 0) {
          var balanceObject = balances.filter(function (b) {
            return b.asset === __WEBPACK_IMPORTED_MODULE_7__utils_constants__["a" /* BTM */];
          })[0];
          balance = balanceObject.balance;
        }
        _this2.accountBalance = balance;
      }).catch(function (error) {
        console.log(error);
      });
    }
  ...
  methods: {
    ...
    close: function close() {
      ...
      __WEBPACK_IMPORTED_MODULE_3__models_account__["a" /* default */].setupNet("" + this.net + this.netType);
    ...
    assetChange: function assetChange(val) {
      ...
      if (val.asset.assetId !== this.selectAsset.asset.assetId) {
        ...
        var balances = this.assets;
        var balance = 0.00;
        if (balances.length > 0) {
          var balanceObject = balances.filter(function (b) {
            return b.asset.assetId === val.asset.assetId;
          })[0];
          balance = __WEBPACK_IMPORTED_MODULE_9__utils_Number__["a" /* Number */].formatNue(balanceObject.availableBalance, 0);
        }
        this.accountBalance = balance;
        __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].asset(val.asset.assetId).then(function (ret) {
          _this3.selectAsset = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(ret, val);
          _this3.transaction.cost = Number(ret[currencyInPrice[_this3.currency]] * _this3.transaction.amount).toFixed(2);
        });
      }
    },
    send: function send() {
      ...
      // Bytom => Vapor
      if (this.transaction.type === 'toVapor') {
        __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].chainStatus().then(function (resp) {
          var address = resp.federationAddress;
          __WEBPACK_IMPORTED_MODULE_3__models_account__["a" /* default */].setupNet("" + _this4.net);
          _this4.transaction.to = address;
          __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].build(_this4.address, address, _this4.transaction.asset, _this4.transaction.amount, _this4.transaction.confirmations).then(function (result) {
            loader.hide();
            if (!_this4.transaction.fee) {
              _this4.transaction.fee = Number(__WEBPACK_IMPORTED_MODULE_10_lodash___default.a.sumBy(result, 'tx.fee'));
            }
            _this4.$router.push({ name: 'transfer-confirm',
              params: {
                account: _this4.account,
                transaction: _this4.transaction,
                rawData: result,
                assetAlias: _this4.selectAsset.asset.symbol,
            ...
            loader.hide();
            _this4.$dialog.show({
              body: Object(__WEBPACK_IMPORTED_MODULE_5__assets_language_sdk__["a" /* default */])(error.message)
            });
          });
        });
      }
      ...
      // Vapor => Bytom
          ...
          var toAddress = this.account.address;
          __WEBPACK_IMPORTED_MODULE_3__models_account__["a" /* default */].setupNet(this.net + "vapor");
          this.transaction.to = toAddress;
          __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].buildCrossChain(this.address, toAddress, this.transaction.asset, this.transaction.amount, this.transaction.confirmations).then(function (result) {
            loader.hide();
            if (!_this4.transaction.fee) {
              _this4.transaction.fee = Number(__WEBPACK_IMPORTED_MODULE_10_lodash___default.a.sumBy(result, 'tx.fee'));
            }
    ...
    if (this.$route.query.type === 'popup') {
      if (this.$route.query.from != undefined) {
        ...
        this.account = this.accountList.filter(function (e) {
          return e.guid === _this5.guid;
        })[0];
      }
    ...
    var currentAsset = this.currentAccount.balances[0];

    if (currentAsset) {
      __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].asset(currentAsset.asset.assetId).then(function (ret) {
        _this5.selectAsset = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(ret, currentAsset);
      });
    }
  }
});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(84)("34a93ba9", content, true, {});
...
// module
exports.push([module.i, ".header[data-v-aa5cc95c]{display:flex}.header p[data-v-aa5cc95c]{text-align:center;width:270px;padding-top:17px}.transferType[data-v-aa5cc95c]{margin:20px;display:flex}.transferType input[type=radio][data-v-aa5cc95c]{position:absolute;visibility:hidden}.transferType input[type=radio]:checked+label[data-v-aa5cc95c]{color:#fff;background:linear-gradient(90deg,#227af1 100%,#035bd4 0)}.transferType input[type=radio]:checked+label .cross-icon[data-v-aa5cc95c]{background-image:url(" + escape(__webpack_require__(655)) + ")}.transferType div:last-child input[type=radio]:checked+label[data-v-aa5cc95c]{color:#fff;background:linear-gradient(91deg,#4b4b4b .27%,#1c1c1c 99.68%)}.transferType div:last-child input[type=radio]:checked+label .cross-icon[data-v-aa5cc95c]{background-image:url(" + escape(__webpack_require__(656)) + ")}.transferType div:last-child .choice[data-v-aa5cc95c]{border-radius:0 40px 40px 0}.choice[data-v-aa5cc95c]{cursor:pointer;padding:10px;font-size:12px;white-space:pre-wrap;display:flex;width:140px;background:rgba(0,0,0,.04);border-radius:40px 0 0 40px}.choice[data-v-aa5cc95c]:hover{background-color:#f7f7f7}.form-container[data-v-aa5cc95c]{margin:20px}.form[data-v-aa5cc95c]{margin-bottom:20px;padding:10px 15px;border-radius:4px}.form-container .btn[data-v-aa5cc95c]{height:48px;bottom:20px;position:absolute;width:320px}.small[data-v-aa5cc95c]{font-size:12px}.wallet[data-v-aa5cc95c]{width:40px;height:40px;background:hsla(0,0%,100%,.1);border-radius:50%;color:#fff;margin-right:20px;line-height:40px;text-align:center}.asset-option[data-v-aa5cc95c]{font-size:15px;text-transform:uppercase}.asset-option .asset-id[data-v-aa5cc95c]{font-size:13px}.v-select[data-v-aa5cc95c]{height:50px;width:100%;background:#f7f7f7;font-size:14px;margin:auto;border-bottom:1px solid #e0e0e0}.cross-icon[data-v-aa5cc95c]{background-image:url(" + escape(__webpack_require__(657)) + ");height:40px;width:40px;margin:auto 12px}.separator[data-v-aa5cc95c]{height:12px}", ""]);
...
module.exports = __webpack_require__.p + "assets/img/crosschain-toV.2a2aff8.svg";
...
module.exports = __webpack_require__.p + "assets/img/crosschain-toB.e5e862f.svg";
...
module.exports = __webpack_require__.p + "assets/img/crosschain-default.1d5d319.svg";
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"warp-chlid bg-white"},[_c('section',{staticClass:"header bg-header"},[_c('i',{staticClass:"iconfont icon-back",on:{"click":_vm.close}}),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.$t('crossChain.title')))])]),_vm._v(" "),_c('section',{staticClass:"transferType"},[_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.transaction.type),expression:"transaction.type"}],attrs:{"type":"radio","id":"typeChoice1","value":"toVapor"},domProps:{"checked":_vm._q(_vm.transaction.type,"toVapor")},on:{"change":function($event){_vm.$set(_vm.transaction, "type", "toVapor")}}}),_vm._v(" "),_c('label',{staticClass:"choice",attrs:{"for":"typeChoice1"}},[_c('div',{staticClass:"cross-icon"}),_c('div',[_vm._v(_vm._s(_vm.$t('crossChain.toVapor')))])])]),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.transaction.type),expression:"transaction.type"}],attrs:{"type":"radio","id":"typeChoice2","value":"toBytom"},domProps:{"checked":_vm._q(_vm.transaction.type,"toBytom")},on:{"change":function($event){_vm.$set(_vm.transaction, "type", "toBytom")}}}),_vm._v(" "),_c('label',{staticClass:"choice",attrs:{"for":"typeChoice2"}},[_c('div',{staticClass:"cross-icon"}),_c('div',[_vm._v(_vm._s(_vm.$t('crossChain.toBytom')))])])])]),_vm._v(" "),_c('section',{staticClass:"form-container"},[_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v(_vm._s(_vm.$t('crossChain.asset')))]),_vm._v(" "),_c('div',{staticClass:"form-item-content"},[_c('v-select',{attrs:{"options":_vm.assets,"colorBlack":true,"clearable":false,"value":_vm.selectAsset,"onChange":_vm.assetChange,"label":"asset"},scopedSlots:_vm._u([{key:"selected-option",fn:function(asset){return [_c('div',{staticClass:"asset-option"},[_c('div',[_vm._v(_vm._s(asset.asset.symbol || 'Asset'))]),_vm._v(" "),_c('div',{staticClass:"color-grey asset-id"},[_vm._v(_vm._s(_vm.shortAddress(asset.asset.assetId)))])])]}},{key:"option",fn:function(asset){return [_c('div',{staticClass:"asset-option"},[_c('div',[_vm._v(_vm._s(asset.asset.symbol || 'Asset'))]),_vm._v(" "),_c('div',{staticClass:"color-grey  asset-id"},[_vm._v(_vm._s(_vm.shortAddress(asset.asset.assetId)))])])]}}])})],1)])]),_vm._v(" "),_c('div',{staticClass:"separator bg-gray"}),_vm._v(" "),_c('section',{staticClass:"form-container"},[_c('div',{},[_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v("\n                "+_vm._s(_vm.$t('transfer.quantity'))+"\n\n                "),_c('small',{staticClass:"float-right",staticStyle:{"margin-right":"8px"}},[_vm._v(_vm._s(_vm.formatCurrency(_vm.transaction.cost||0)))])]),_vm._v(" "),_c('div',{staticClass:"form-item-content",staticStyle:{"display":"flex"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.transaction.amount),expression:"transaction.amount"}],attrs:{"type":"number","placeholder":_vm.bytomBalance},domProps:{"value":(_vm.transaction.amount)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.transaction, "amount", $event.target.value)}}}),_vm._v(" "),_c('span',{staticClass:"color-grey",staticStyle:{"width":"40px","font-size":"15px","position":"absolute","right":"0"}},[_vm._v(_vm._s(_vm.unit))])]),_vm._v(" "),_c('p',{staticClass:"small color-grey"},[_vm._v(_vm._s(_vm.$t('crossChain.amountHint')))])])]),_vm._v(" "),_c('a',{staticClass:"btn btn-primary",on:{"click":_vm.send}},[_vm._v(_vm._s(_vm.$t('transfer.send')))])])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
