...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_veto_vue__ = __webpack_require__(601);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6e916f96_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_veto_vue__ = __webpack_require__(649);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6e916f96"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_veto_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6e916f96_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_veto_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
        bytomBalance: function bytomBalance() {
            var vote = this.selectVote;
            var vetoAmount = void 0;
            if (vote && vote.total > vote.locked) {
                vetoAmount = __WEBPACK_IMPORTED_MODULE_6__utils_Number__["a" /* Number */].formatNue(vote.total - vote.locked, 8);
            }

            return "" + this.$t("listCancel.availableVeto") + (vetoAmount != null && vetoAmount != 0 ? vetoAmount : '0.00');
        }
    }, Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["d" /* mapState */])(['bytom', 'selectVote']), Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["c" /* mapGetters */])(['currentAccount', 'accountList', 'net', 'netType', 'currency'])),
    watch: {
    ...
    methods: {
        ...
        send: function send() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__models_transaction__["a" /* default */].buildVeto(this.currentAccount.vpAddress, vote, this.transaction.amount, this.transaction.confirmations).then(function (result) {
                loader.hide();
                if (!_this.transaction.fee) {
                    _this.transaction.fee = Number(_.sumBy(result, 'tx.fee'));
                }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(84)("405be9b3", content, true, {});
...
// module
exports.push([module.i, ".header[data-v-6e916f96]{display:flex}.header p[data-v-6e916f96]{text-align:center;width:270px;padding-top:17px}.transferType input[type=radio][data-v-6e916f96]{position:absolute;visibility:hidden}.transferType input[type=radio]:checked+label[data-v-6e916f96]{color:#fff;background-color:#333}.form-container[data-v-6e916f96]{margin:20px}.form[data-v-6e916f96]{margin-bottom:20px;padding:10px 15px;border-radius:4px}.form-container .btn[data-v-6e916f96]{height:48px;bottom:20px;position:absolute;width:320px}.vote-title[data-v-6e916f96]{font-size:14px;color:#000;vertical-align:middle;align-items:center;display:flex}.vote-title img[data-v-6e916f96]{height:36px;width:36px;border:1px solid #e0e0e0;opacity:1;border-radius:4px;margin-right:15px}", ""]);
