...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_vote_vue__ = __webpack_require__(600);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6019a2ae_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_vote_vue__ = __webpack_require__(646);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6019a2ae"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_vote_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6019a2ae_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_vote_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_language_sdk__ = __webpack_require__(579);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sendTransaction_transferConfirm__ = __webpack_require__(533);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_constants__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vuex__ = __webpack_require__(433);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_Number__ = __webpack_require__(580);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__(434);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: {
        Confirm: __WEBPACK_IMPORTED_MODULE_3__sendTransaction_transferConfirm__["default"]
    },
    data: function data() {
        return {
            selectAsset: {
                asset: __WEBPACK_IMPORTED_MODULE_4__utils_constants__["a" /* BTM */],
                symbol: "BTM",
                decimals: 8
            },
            show: false,
    ...
    }, Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["d" /* mapState */])(['bytom', 'selectVote']), Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["c" /* mapGetters */])(['currentAccount', 'accountList', 'net', 'currency', 'netType'])),
    watch: {
    ...
    methods: {
        ...
        formatCurrency: function formatCurrency(num) {
            return __WEBPACK_IMPORTED_MODULE_6__utils_Number__["a" /* Number */].formatCurrency(num, this.currency);
        },
        send: function send() {
            var _this = this;
            ...
            var vote = this.selectVote.pubKey;
            this.transaction.to = vote;
            __WEBPACK_IMPORTED_MODULE_1__models_transaction__["a" /* default */].buildVote(this.currentAccount.vpAddress, vote, this.transaction.amount, this.transaction.confirmations).then(function (result) {
                loader.hide();
                if (!_this.transaction.fee) {
                    _this.transaction.fee = Number(__WEBPACK_IMPORTED_MODULE_7_lodash___default.a.sumBy(result, 'tx.fee'));
                }
                _this.$router.push({ name: 'vote-confirm', params: { account: _this.currentAccount, transaction: _this.transaction, assetAlias: 'BTM', rawData: result } });
            }).catch(function (error) {
                loader.hide();
                _this.$dialog.show({
                    body: Object(__WEBPACK_IMPORTED_MODULE_2__assets_language_sdk__["a" /* default */])(error.message)
                });
            });
        }
    }, mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__models_transaction__["a" /* default */].asset(__WEBPACK_IMPORTED_MODULE_4__utils_constants__["a" /* BTM */]).then(function (ret) {
            _this2.selectAsset = ret;
        });
    }
});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(84)("1c5e9e70", content, true, {});
...
// module
exports.push([module.i, ".header[data-v-6019a2ae]{display:flex}.header p[data-v-6019a2ae]{text-align:center;width:270px;padding-top:17px}.transferType input[type=radio][data-v-6019a2ae]{position:absolute;visibility:hidden}.transferType input[type=radio]:checked+label[data-v-6019a2ae]{color:#fff;background-color:#333}.form-container[data-v-6019a2ae]{margin:20px}.form[data-v-6019a2ae]{margin-bottom:20px;padding:10px 15px;border-radius:4px}.form-container .btn[data-v-6019a2ae]{height:48px;bottom:20px;position:absolute;width:320px}.vote-title[data-v-6019a2ae]{font-size:14px;color:#000;vertical-align:middle;align-items:center;display:flex}.vote-title img[data-v-6019a2ae]{height:36px;width:36px;border:1px solid #e0e0e0;opacity:1;border-radius:4px;margin-right:15px}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"warp-chlid bg-gray"},[_c('section',{staticClass:"header bg-header"},[_c('i',{staticClass:"iconfont icon-back",on:{"click":_vm.close}}),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.$t('listVote.vote')))])]),_vm._v(" "),_c('section',{staticClass:"form-container"},[_c('div',{staticClass:"form bg-white"},[(_vm.selectVote !== null)?_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v(_vm._s(_vm.$t('vote.selectNode')))]),_vm._v(" "),_c('div',{staticClass:"form-item-content"},[_c('div',{staticClass:"vote-title"},[_c('img',{attrs:{"src":_vm.selectVote.logo,"alt":""}}),_vm._v(" "),_c('div',[_vm._v("\n                "+_vm._s(_vm.selectVote.name)+"\n              ")])])])]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"form bg-white"},[_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v("\n                "+_vm._s(_vm.$t('transfer.quantity'))+"\n\n              ")]),_vm._v(" "),_c('div',{staticClass:"form-item-content",staticStyle:{"display":"flex"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.transaction.amount),expression:"transaction.amount"}],attrs:{"type":"number","placeholder":_vm.bytomBalance},domProps:{"value":(_vm.transaction.amount)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.transaction, "amount", $event.target.value)}}}),_vm._v(" "),_c('span',{staticClass:"color-grey",staticStyle:{"width":"40px","font-size":"15px","position":"absolute","right":"0"}},[_vm._v(_vm._s(_vm.unit))])])])]),_vm._v(" "),_c('a',{staticClass:"btn btn-primary",on:{"click":_vm.send}},[_vm._v(_vm._s(_vm.$t('transfer.confirm')))])])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
