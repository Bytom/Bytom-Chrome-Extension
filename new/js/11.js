...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_assetList_vue__ = __webpack_require__(595);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9beabd34_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_assetList_vue__ = __webpack_require__(629);
...
/* scopeId */
var __vue_scopeId__ = "data-v-9beabd34"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_assetList_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9beabd34_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_assetList_vue__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_query__ = __webpack_require__(591);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_transaction__ = __webpack_require__(577);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_utils__ = __webpack_require__(578);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_constants__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vuex__ = __webpack_require__(433);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__store_constants__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lodash__ = __webpack_require__(434);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils_Number__ = __webpack_require__(580);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    ...
    'currentAccount.balances': function currentAccountBalances() {
      var _this = this;
      ...
      this.start = 0;
      this.refreshTransactions(this.start, this.limit).then(function (transactions) {
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_7_vuex__["d" /* mapState */])(['bytom', 'currentAsset', 'listVote']), Object(__WEBPACK_IMPORTED_MODULE_7_vuex__["c" /* mapGetters */])(['currentAccount', 'currency', 'netType'])),
  methods: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
    camelize: function camelize(object) {
      return Object(__WEBPACK_IMPORTED_MODULE_5__utils_utils__["a" /* camelize */])(object);
    },
    ...
    formatCurrency: function formatCurrency(num) {
      return __WEBPACK_IMPORTED_MODULE_10__utils_Number__["a" /* Number */].formatCurrency(num, this.currency);
    },
    itemBalance: function itemBalance(asset) {
      if (asset.asset === __WEBPACK_IMPORTED_MODULE_6__utils_constants__["a" /* BTM */]) {
        return __WEBPACK_IMPORTED_MODULE_10__utils_Number__["a" /* Number */].formatNue(asset.availableBalance, 8);
      } else {
        return __WEBPACK_IMPORTED_MODULE_10__utils_Number__["a" /* Number */].formatNue(asset.availableBalance, asset.decimals);
      }
    },
      ...
      if (vertical.process == 1 && this.transactions.length == (this.start + 1) * this.limit) {
        ...
        this.refreshTransactions(this.start, this.limit).then(function (transactions) {
          transactions.forEach(function (transaction) {
            _this2.transactions.push(transaction);
          });
        });
      }
    },

    refreshTransactions: function refreshTransactions(start, limit) {
      var _this3 = this;

      return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].list(_this3.address, _this3.currentAsset.asset.assetId, start, limit).then(function (transactions) {
          if (transactions == null) {
            return;
          }

          var formattedTx = _this3.transactionsFormat(transactions);
          resolve(formattedTx);
        }).catch(function (error) {
          console.log(error);
          reject(error);
    ...
    transactionsFormat: function transactionsFormat(transactions) {
      var _this4 = this;

      var formattedTransactions = [];
      var assetID = this.currentAsset.asset.assetId;

      transactions.forEach(function (transaction) {
        var balanceObject = transaction.balances.filter(function (b) {
          return b.asset.assetId === assetID;
        });

        var filterInput = __WEBPACK_IMPORTED_MODULE_9_lodash___default.a.find(transaction.inputs, function (o) {
          return o.type == 'veto';
        });
        var filterOutput = __WEBPACK_IMPORTED_MODULE_9_lodash___default.a.find(transaction.outputs, function (o) {
          return o.type == 'vote';
        });

        if (filterInput) {
          transaction.type = 'veto';
          var inAmount = __WEBPACK_IMPORTED_MODULE_9_lodash___default.a.sumBy(transaction.inputs.filter(function (i) {
            return i.type === 'veto';
          }), 'amount');
          var outAmount = __WEBPACK_IMPORTED_MODULE_9_lodash___default.a.sumBy(transaction.outputs.filter(function (i) {
            return i.type === 'vote';
          }), 'amount');
          transaction.pubkey = filterInput.vote;
          transaction.vAmount = __WEBPACK_IMPORTED_MODULE_10__utils_Number__["a" /* Number */].formatNue(inAmount - outAmount, 8);
        } else if (filterOutput) {
          var _outAmount = __WEBPACK_IMPORTED_MODULE_9_lodash___default.a.sumBy(transaction.outputs.filter(function (i) {
            return i.type === 'vote';
          }), 'amount');
          transaction.pubkey = filterOutput.vote;
          transaction.vAmount = __WEBPACK_IMPORTED_MODULE_10__utils_Number__["a" /* Number */].formatNue(_outAmount, 8);
          transaction.type = 'vote';
        } else if (transaction.types.includes('out_crosschain')) {
          transaction.type = 'crossChain';
          if (_this4.netType === 'vapor') {
        ...
        var inputAddresses = transaction.inputs.filter(function (input) {
          return input.asset.assetId === assetID && input.address !== _this4.currentAccount.address;
        }).map(function (input) {
          return input.address;
        });

        var outputAddresses = transaction.outputs.filter(function (output) {
          return output.asset.assetId === assetID && output.address !== _this4.currentAccount.address;
        }).map(function (output) {
          return output.address;
        });

        if (balanceObject.length === 1) {
          var val = Math.abs(balanceObject[0].amount);

          if (Number(balanceObject[0].amount) > 0) {
            transaction.direct = "+";
            var resultAddr = inputAddresses.pop();
            transaction.address = resultAddr && resultAddr.includes(' ') ? resultAddr : __WEBPACK_IMPORTED_MODULE_2__utils_address__["a" /* default */].short(resultAddr);
          } else {
            transaction.direct = "-";
            var _resultAddr = outputAddresses.pop();
            transaction.address = _resultAddr && _resultAddr.includes(' ') ? _resultAddr : __WEBPACK_IMPORTED_MODULE_2__utils_address__["a" /* default */].short(_resultAddr);
          }
          ...
          transaction.val = 0;
          transaction.address = __WEBPACK_IMPORTED_MODULE_2__utils_address__["a" /* default */].short(_this4.address);
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_7_vuex__["b" /* mapActions */])([__WEBPACK_IMPORTED_MODULE_8__store_constants__["n" /* UPDATE_STORED_BYTOM */], __WEBPACK_IMPORTED_MODULE_8__store_constants__["l" /* SET_LIST_VOTE */]])),
  mounted: function mounted() {
    var _this5 = this;

    this.refreshTransactions(this.start, this.limit).then(function (transactions) {
      _this5.transactions = transactions;
    });
    if (this.listVote.length == 0 && this.netType === 'vapor') {
      __WEBPACK_IMPORTED_MODULE_3__models_query__["a" /* default */].chainStatus().then(function (resp) {
        if (resp) {
          var votes = resp.consensusNodes.map(function (item, index) {
            item.rank = index + 1;
            return item;
          });
          _this5[__WEBPACK_IMPORTED_MODULE_8__store_constants__["l" /* SET_LIST_VOTE */]](votes);
        }
      });
    }
  }
...
var update = __webpack_require__(84)("c4e8352e", content, true, {});
