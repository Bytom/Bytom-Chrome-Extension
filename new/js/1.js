...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_transfer_vue__ = __webpack_require__(594);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_01de7bd4_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_transfer_vue__ = __webpack_require__(626);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-01de7bd4"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_01de7bd4_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_transfer_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utils_Number__ = __webpack_require__(580);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vuex__ = __webpack_require__(433);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__store_constants__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_lodash__ = __webpack_require__(434);
...
/* harmony default export */ __webpack_exports__["a"] = ({
        ...
        assets: function assets() {
            if (this.netType === 'vapor') {
                if (!this.currentAccount.vpBalances || this.currentAccount.vpBalances.length == 0) {
                    ...
                    return this.currentAccount.vpBalances.map(function (b) {
                        return b.asset;
                    });
                }
            } else {
                if (!this.currentAccount.balances || this.currentAccount.balances.length == 0) {
                    ...
                    return this.currentAccount.balances.map(function (b) {
                        return b.asset;
                    });
                }
            }
    ...
    }, Object(__WEBPACK_IMPORTED_MODULE_9_vuex__["d" /* mapState */])(['bytom']), Object(__WEBPACK_IMPORTED_MODULE_9_vuex__["c" /* mapGetters */])(['currentAccount', 'accountList', 'currency', 'netType'])),
    watch: {
        "transaction.amount": function transactionAmount(newAmount) {
            var singlePrice = this.selectAsset[currencyInPrice[this.currency]] || this.selectAsset[this.currency] || 0;
        ...
        address: function address(newAddress) {
            var _this = this;

            __WEBPACK_IMPORTED_MODULE_3__models_account__["a" /* default */].balance(newAddress).then(function (obj) {
                var balances = obj.balances;
                var balance = 0.00;
                if (balances.length > 0) {
                    var balanceObject = balances.filter(function (b) {
                        return b.asset.assetId === _this.selectAsset.assetId;
                    })[0];
                    balance = __WEBPACK_IMPORTED_MODULE_8__utils_Number__["a" /* Number */].formatNue(balanceObject.balance, balanceObject.decimals);
                }
    ...
    methods: {
        ...
        formatCurrency: function formatCurrency(num) {
            return __WEBPACK_IMPORTED_MODULE_8__utils_Number__["a" /* Number */].formatCurrency(num, this.currency);
        },
        limitAmount: function limitAmount($event) {
        ...
        assetChange: function assetChange(val) {
            ...
            if (val.assetId !== this.selectAsset.assetId) {
                ...
                var balances = this.netType === 'vapor' ? this.currentAccount.vpBalances : this.currentAccount.balances;
                var balance = 0.00;
                if (balances.length > 0) {
                    console.log(balances);
                    var balanceObject = balances.filter(function (b) {
                        return b.asset.assetId === val.assetId;
                    })[0];
                    balance = balanceObject.balance;
                }
                this.accountBalance = balance;

                __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].asset(val.assetId).then(function (ret) {
                    console.log(ret);
                    _this2.selectAsset = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(ret, val);
                    _this2.transaction.cost = Number(ret[currencyInPrice[_this2.currency]] * _this2.transaction.amount).toFixed(2);
                });
            }
        },
        close: function close() {
        ...
        send: function send() {
            ...
            __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].build(this.address, this.transaction.to, this.transaction.asset, this.transaction.amount, this.transaction.fee, this.transaction.confirmations).then(function (result) {
                console.log(result);
                loader.hide();
                if (!_this3.transaction.fee) {
                    _this3.transaction.fee = Number(__WEBPACK_IMPORTED_MODULE_11_lodash___default.a.sumBy(result, 'tx.fee'));
                }
                _this3.$router.push({ name: 'transfer-confirm', params: { account: _this3.account, transaction: _this3.transaction, rawData: result, assetAlias: _this3.selectAsset.symbol, type: _this3.$route.query.type } });
            }).catch(function (error) {
                loader.hide();
                _this3.$dialog.show({
        ...
        if (this.$route.query.type === 'popup') {
            ...
            if (this.$route.query.asset != undefined) {
                var currentAssetId = this.$route.query.asset;

                this.transaction.asset = currentAssetId;

                var assets = this.assets;
                this.selectAsset = assets.filter(function (b) {
                    return b.assetId === currentAssetId.toLowerCase();
                })[0];
            }
            ...
            var currentAsset = this.netType === 'vapor' ? this.currentAccount.vpBalances[0] : this.currentAccount.balances[0];

            if (currentAsset) {
                __WEBPACK_IMPORTED_MODULE_4__models_transaction__["a" /* default */].asset(currentAsset.asset.assetId).then(function (ret) {
                    _this4.selectAsset = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(ret, currentAsset);
                });
            }
        }
    }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(84)("5ed97310", content, true, {});
...
// module
exports.push([module.i, ".header[data-v-01de7bd4]{display:flex}.header p[data-v-01de7bd4]{text-align:center;width:270px;padding-top:17px}.balance[data-v-01de7bd4]{width:280px;height:40px;margin:20px;padding:20px;display:flex}.balance .token-icon[data-v-01de7bd4]{height:38px;width:38px;margin-right:5px}.balance .token-amount[data-v-01de7bd4]{display:inline-block}.balance .token-amount .asset[data-v-01de7bd4]{font-size:18px;margin-left:2px;text-transform:uppercase}.form-container[data-v-01de7bd4]{margin:20px}.form[data-v-01de7bd4]{margin-bottom:20px;padding:10px 15px;border-radius:4px}.form-container .btn[data-v-01de7bd4]{height:48px;bottom:20px;position:absolute;width:320px}.small[data-v-01de7bd4]{font-size:12px}.transfer-header[data-v-01de7bd4]{background-image:url(" + escape(__webpack_require__(592)) + ");background-size:320px 80px}.wallet[data-v-01de7bd4]{width:40px;height:40px;background:hsla(0,0%,100%,.1);border-radius:50%;color:#fff;margin-right:20px;line-height:40px;text-align:center}.asset-option[data-v-01de7bd4]{font-size:15px;text-transform:uppercase}.asset-option .asset-id[data-v-01de7bd4]{font-size:13px}.v-select[data-v-01de7bd4]{height:50px;width:100%;background:#f7f7f7;font-size:14px;margin:auto;border-bottom:1px solid #e0e0e0}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"warp-chlid bg-gray"},[_c('section',{staticClass:"header bg-header"},[_c('i',{staticClass:"iconfont icon-back",on:{"click":_vm.close}}),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.$t('main.send')))])]),_vm._v(" "),_c('section',{staticClass:"balance transfer-header"},[_vm._m(0),_vm._v(" "),_c('div',[_c('div',{staticClass:"token-amount"},[_vm._v("\n            "+_vm._s(_vm.accountBalance)+"\n            "),(_vm.selectAsset.symbol)?_c('span',{staticClass:"asset"},[_vm._v(_vm._s(_vm.selectAsset.symbol))]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"small color-grey"},[_vm._v("\n          "+_vm._s(_vm.currentAccount.alias)+"\n        ")])])]),_vm._v(" "),_c('section',{staticClass:"form-container"},[_c('div',{staticClass:"form bg-white"},[_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v(_vm._s(_vm.$t('transfer.asset')))]),_vm._v(" "),_c('div',{staticClass:"form-item-content"},[_c('v-select',{attrs:{"options":_vm.assets,"colorBlack":true,"clearable":false,"value":_vm.selectAsset,"onChange":_vm.assetChange,"label":"assetId"},scopedSlots:_vm._u([{key:"selected-option",fn:function(asset){return [_c('div',{staticClass:"asset-option"},[_c('div',[_vm._v(_vm._s(asset.symbol || 'Asset'))]),_vm._v(" "),_c('div',{staticClass:"color-grey asset-id"},[_vm._v(_vm._s(_vm.shortAddress(asset.assetId)))])])]}},{key:"option",fn:function(asset){return [_c('div',{staticClass:"asset-option"},[_c('div',[_vm._v(_vm._s(asset.symbol || 'Asset'))]),_vm._v(" "),_c('div',{staticClass:"color-grey  asset-id"},[_vm._v(_vm._s(_vm.shortAddress(asset.assetId)))])])]}}])})],1)]),_vm._v(" "),_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v(_vm._s(_vm.$t('transfer.address')))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.transaction.to),expression:"transaction.to"}],staticClass:"form-item-content",attrs:{"type":"text"},domProps:{"value":(_vm.transaction.to)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.transaction, "to", $event.target.value)}}})]),_vm._v(" "),_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label",attrs:{"for":"tx-amount"}},[_vm._v("\n                "+_vm._s(_vm.$t('transfer.quantity'))+"\n\n                "),_c('small',{staticClass:"float-right",staticStyle:{"margin-right":"8px"}},[_vm._v(_vm._s(_vm.formatCurrency(_vm.transaction.cost||0)))])]),_vm._v(" "),_c('div',{staticClass:"form-item-content",staticStyle:{"display":"flex"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.transaction.amount),expression:"transaction.amount"}],attrs:{"type":"number","id":"tx-amount","placeholder":"0"},domProps:{"value":(_vm.transaction.amount)},on:{"keypress":_vm.limitAmount,"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.transaction, "amount", $event.target.value)}}}),_vm._v(" "),_c('span',{staticClass:"color-grey",staticStyle:{"font-size":"15px","position":"absolute","right":"0","text-transform":"uppercase"}},[_vm._v(_vm._s(_vm.unit))])])]),_vm._v(" "),_c('div',{staticClass:"form-item"},[_c('label',{staticClass:"form-item-label"},[_vm._v(_vm._s(_vm.$t('transfer.fee')))]),_vm._v(" "),_c('div',{staticClass:"form-item-content"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.fee),expression:"fee"}],attrs:{"type":"text","disabled":""},domProps:{"value":(_vm.fee)},on:{"input":function($event){if($event.target.composing){ return; }_vm.fee=$event.target.value}}})])])]),_vm._v(" "),_c('a',{staticClass:"btn btn-primary",on:{"click":_vm.send}},[_vm._v(_vm._s(_vm.$t('transfer.send')))])])])}
